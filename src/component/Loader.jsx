        ...
        <div className="bg-[#B0B9C2] h-full w-full flex flex-col items-center justify-center">
            <motion.div
                ...
                <video className="hidden lg:block" width="320" height="240" muted autoplay="true" loop>
                    <source src="https://res.cloudinary.com/dja3bc8xm/video/upload/v1686745655/clarence%20Portfolio%20images/EmojiMovie700572202_2_zz0dsy.mov" type="video/mp4" />
                </video>
                <img className="block lg:hidden" width="140" height="140" src="https://em-content.zobj.net/source/microsoft-teams/363/sign-of-the-horns_1f918.png" alt="" />
            </motion.div>
